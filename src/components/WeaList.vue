...
const Item = All_travel.travellist[index]; 

const items = ref([]);
const url = ref(`https://${Item.ip}`); 
...
<template>
  <section class="vh-100" >
    <div><h1 style="text-align: center;" class="text_box"><strong>สภาพอากาศจังหวัด {{Item.name}} </strong></h1></div>
